      ...
      <div className="form-grid">
        ...
        {setupForm.mode !== "join_workspace" ? (
          <label>
            <span className="label-with-tip">
              Workspace code
              <FieldTip tip="A short, URL-safe slug that identifies your organization's workspace (e.g. community-action-network). You choose it when creating an account; returning users enter it on sign-in so Grant Keeper knows which workspace to load." />
            </span>
        ...
        {setupForm.mode === "join_workspace" ? (
          <label>
            <span className="label-with-tip">
              Invite token
              <FieldTip tip="A one-time code (starting with gk-) generated by your workspace owner on the Org Profile page. Enter it here to join an existing workspace as a second writer. Each token can only be used once." />
            </span>
